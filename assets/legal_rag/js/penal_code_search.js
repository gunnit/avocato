document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadBooks() {
        try {
            const response = await fetch('/legal-rag/api/penal-code/books/');
    ...
    async function loadArticles(filters = {}) {
        try {
            ...
            const response = await fetch(`/legal-rag/api/penal-code/articles/?${queryParams}`);
    ...
    window.showArticleDetail = async function(articleId) {
        try {
            const response = await fetch(`/legal-rag/api/penal-code/articles/${articleId}/`);
